...
moduleForAcceptance('Acceptance | new platform mssql fulltext test stand language l');

test('testing /new-platform-mssql-fulltext-test-stand-language-l', function(assert) {
