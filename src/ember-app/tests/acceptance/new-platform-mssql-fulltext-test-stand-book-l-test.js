...
moduleForAcceptance('Acceptance | new platform mssql fulltext test stand book l');

test('testing /new-platform-mssql-fulltext-test-stand-book-l', function(assert) {
