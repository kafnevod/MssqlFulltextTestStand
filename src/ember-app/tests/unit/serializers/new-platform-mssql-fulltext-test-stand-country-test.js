...
moduleForModel('new-platform-mssql-fulltext-test-stand-country', 'Unit | Serializer | new-platform-mssql-fulltext-test-stand-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-mssql-fulltext-test-stand-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
