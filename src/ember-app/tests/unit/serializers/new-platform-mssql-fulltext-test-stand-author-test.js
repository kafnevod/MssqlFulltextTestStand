...
moduleForModel('new-platform-mssql-fulltext-test-stand-author', 'Unit | Serializer | new-platform-mssql-fulltext-test-stand-author', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-mssql-fulltext-test-stand-author',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
