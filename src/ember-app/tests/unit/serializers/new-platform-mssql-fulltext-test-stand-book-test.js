...
moduleForModel('new-platform-mssql-fulltext-test-stand-book', 'Unit | Serializer | new-platform-mssql-fulltext-test-stand-book', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-mssql-fulltext-test-stand-book',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
